...
export const DraggablePenList: React.FC<DraggablePenListProps> = ({
  ...
  const getXY = (e: React.TouchEvent | React.MouseEvent | TouchEvent | MouseEvent): { x: number; y: number } => {
    ...
    return { x: (e as MouseEvent).clientX, y: (e as MouseEvent).client
        ...
        {orderedPens.map((pen) => {
          ...
          return (
            ...
            <div className="flex items-center gap-1 mb-2">
              ...
              className={`flex-none w-32 h-40 snap-center backdrop-blur-sm rounded-[2rem] p-3 shadow-lg flex flex-col items-center justify-between group relative overflow-hidden ${
                isTarget
